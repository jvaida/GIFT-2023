 ...
 * this work.
 */
package mil.arl.gift.gateway.interop.dreamscape;
 ...
 *
 */
public class DreamscapePluginInterface extends AbstractInteropInterface {

    /** The logger for the class */
    private static final Logger logger = LoggerFactory.getLogger(DreamscapePluginInterface.class);
    ...
    /**
     * Constructs a new {@link DreamscapePluginInterface} with the provided display name.
     *
     * @param displayName The display name of this {@link DreamscapePluginInterface}. Can't
     *        be null.
     */
    public DreamscapePluginInterface(String displayName) {
